...
async function handler(req, res) {
    if (req.method === "POST") {
        ...
        const client = await external_mongodb_namespaceObject.MongoClient.connect("mongodb+srv://makov:RdfJs293FKuviVnX@cluster0.xx0ofml.mongodb.net/meetups?retryWrites=true&w=majority");
        const db = client.db();
